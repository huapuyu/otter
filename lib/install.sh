...
mvn install:install-file -DgroupId=mockit -DartifactId=mockit -Dversion=0.999.10 -Dpackaging=jar -Dfile=mockit-0.999.10.jar -Dsources=mockit-0.999.10-sources.jar
